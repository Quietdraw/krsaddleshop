	...
	,	setTermsAndConditions: function (data)
		{
			...
			if (require_terms_and_conditions.toString() === 'T' && this.isSecure && !_.isUndefined(data.agreetermcondition) && session.isLoggedIn2())
			{
	...
	,	setTransactionBodyField: function (data)
		{
			...
			if (this.isSecure && !_.isEmpty(data.options) && session.isLoggedIn2())
			{
