...
//@module ItemViews
define(
	'ItemViews.SelectedOption.View.CustomImage'
,	[
	...
	)
{
	...
	return _.extend(ItemViewsSelectedOptionView.prototype, {

		getCustomImage: function (label) {
			// Silver/Smoke => silversmoke
			// Silver / Smoke => silver__smoke
			// Tiger's Eye => tigers_eye
			label = label.replace(/\s+/g, '_').replace(/\W/g, '').toLowerCase();
