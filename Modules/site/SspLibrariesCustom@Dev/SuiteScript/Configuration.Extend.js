...
define('Configuration.Extend',["Configuration"] ,function(configuration)
{
	'use strict';
	...
	,	order_checkout_field_keys: {
			'items': [
				...
				,	'itemtype'
				,	'itemid'
				,	'custitem_leather_color'
			,	'custitem_subclass'
			,	'custitem_personalization_style'
			,	'custitem_personalization_code'
			,	'custitem_personalization'
			,	'custitem1'
			,	'custitem_womens_boots'
			,	'custitem_size'
			,	'custitem_shirt'
			,	'custitem_ring_sizes'
			,	'custitem_other'
			,	'custitem_neck_sleeve_shirt'
			,	'custitem_mens_boots_width'
			,	'custitem_mens_boots'
			,	'custitem_leather'
			,	'custitem_kids_boots'
			,	'custitem_jewelry'
	...
	,	product_lists: {
		...
		,	list_templates: [
				...
				,	description: 'A great place to house favorite items'
